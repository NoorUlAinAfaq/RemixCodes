...
contract SIOE is Context, Ownable, IERC20, ERC20Detailed {
    ...
    uint256 public buyTeamFee = 268;
    uint256 public sellTeamFee = 268;
    uint256 public transferFee = 40;
    uint256 public teamFee;
    address payable public teamAddress = payable(owner());
    ...
    constructor () ERC20Detailed("Smart internet of evrything", "SIOE", 9) {
    
    _totalSupply = 500000000 * (10**9);
    ...
    function setTeamFeePercent(uint256 updatedBuyTeamFee, uint256 updatedSellTeamFee, uint256 updatedTransferTeamFee) external onlyOwner {
        buyTeamFee = updatedBuyTeamFee;
        sellTeamFee = updatedSellTeamFee;
        transferFee = updatedTransferTeamFee;
        require(buyTeamFee + sellTeamFee + transferFee  <= 10, "Fee is crossing the boundaries");
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        {
            require(tradingEnabled, "Trading is not emabled yet");
        }
        ...
        {teamFee = transferFee;}
        else if(AMMs[recipient]) { teamFee = sellTeamFee;}
        else if(AMMs[sender]) { teamFee = buyTeamFee; }
        ...
        if(takeFee)
        {
            uint256 taxAmount = (amount * (teamFee)) / (10000);
      ...
      function swapAndLiquify(uint256 tokensToLiquify) private {
        ...
        payable(teamAddress).transfer(ethBalance);
